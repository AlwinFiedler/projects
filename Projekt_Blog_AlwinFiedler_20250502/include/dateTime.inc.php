...
// if(DEBUG_F)				echo "<pre class='debug dateTime'><b>Line " . __LINE__ . "</b>: \$dateTimeArray<br>". print_r($dateTimeArray, true) . "<i>(" . basename(__FILE__) . ")</i>:</pre>\n";
...
// if(DEBUG_F)			echo "<pre class='debug dateTime'><b>Line " . __LINE__ . "</b>: \$dateArray<br>". print_r($dateArray, true) . "<i>(" . basename(__FILE__) . ")</i>:</pre>\n";
